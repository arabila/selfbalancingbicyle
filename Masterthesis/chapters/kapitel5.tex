...
%------------------------------------------------------------------------------------------------
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Kurve.jpeg}  
    \caption{Kurvenfahrt}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Kurve/Daten_Yolo.png}  
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Kurve/Error_Yolo.png}  
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Kurve/Daten_Fallback.png}  
    \caption{Daten Fallback Kurve}
    \label{fig:daten-fallback-kurve}
  \end{figure}

  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/Kurve/Error_Fallback.png}  
  ...
  \subsubsection{S-Kurve}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{figures/S-Kurve.png}  
      \caption{S-Kurve}
      \label{fig:s-kurve}
    \end{figure}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{figures/S-Kurve/Yolo_Daten.png}  
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{figures/S-Kurve/Yolo_Error.png}  
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{figures/S-Kurve/Fallback_Daten.png}  
      \caption{Fallback Daten S-Kurve}
      \label{fig:fallback-daten-s-kurve}
    \end{figure}
  
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{figures/S-Kurve/Fallback_Error.png}  
      \caption{Fallback Error S-Kurve}
      \label{fig:fallback-error-s-kurve}
    \end{figure}
