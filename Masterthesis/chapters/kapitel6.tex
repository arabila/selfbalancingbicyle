...
bestimmt, beeinträchtigt die Realitätstreue der Fahrdynamik erheblich \cite{catto2009ode_friction}. Im Gegensatz zu den in der 
Fahrzeugdynamik etablierten detaillierten Reifenmodellen \cite{schramm2018fahrzeugdynamik} vernachlässigt die ODE-Simulation 
...
was die Validität der Simulationsergebnisse gefährdet \cite{smith2006ode_stability}. Zusätzlich vernachlässigt die vereinfachte 
