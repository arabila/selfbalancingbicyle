...
\section{Simulationsumgebung}
  ...
  \begin{figure}[h]
    ...
    \caption{IMU-Knoten in Webots.\\ \footnotesize{Quelle: \url{https://cyberbotics.com/doc/reference/inertialunit}}}
    \label{fig:imu}
  \end{figure}
  ...
  \begin{figure}[H]
    ...
    \caption{Kamera-Knoten in Webots.\\ \footnotesize{Quelle: \url{https://cyberbotics.com/doc/reference/camera}}}
    \label{fig:camera}
  \end{figure}
  ...
  unter Berücksichtigung von Maximalmoment und Zielvorgabe. Jeder Rotationsmotor kann in drei Modi betrieben werden:
    ...
    \begin{figure}[H]
      ...
      \caption{\centering Aktuatoren im Fahrradmodell. \\ \footnotesize{Quelle: \url{https://cyberbotics.com/doc/reference/rotationalmotor}}}
  ...
  \begin{wrapfigure}{r}{0.5\textwidth} % r=rechts, l=links
    ...
    \caption{\centering Synchronisation zwischen Controller und Simulation. \\ \footnotesize{Quelle: \url{https://cyberbotics.com/doc/reference/controller}}}
  ...
  \begin{lstlisting}[style=wbt_c,caption={Nachrichtenkanal zwischen Controller und Simulation \texttt{*.wbt}},label={lst:imu4}]
    Robot {
      Controller "balance_control_c"
      Receiver { name "command_rx"  channel 1  bufferSize 64 }
      Emitter  { name "status_tx"   channel 2  bufferSize 64 }
