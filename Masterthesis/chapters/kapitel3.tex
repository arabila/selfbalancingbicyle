...
\section{Webots-Simulationsumgebung}
  ...
  \textbf{Rolle im Regelkreis: } Die Positionssensoren dienen vor allem der Überwachung und der Ableitung von Regelgrößen.
    ...
    Die Gabel sowie das Vorderrad besitzen eine Masse von \texttt{2.5 kg} und eine Trägheitsmatrix von \texttt{0.06 0.07 0.12}, die schnelle Winkeländerungen begrenzen.
  ...
  \begin{itemize}
    ...
    Der Antrieb arbeitet als Positionsantrieb auf einen Sollwinkel mit begrenztem Bereichen in beide Richtungen. 
    ...
    Im realen System regelt ein separater PID die Raddrehzahl konstant, indem er den Motorstrom anhand des Hall-Encoder-Feedbacks justiert. 
  ...
  zurück. Abbildung \ref{fig:controller_sync} veranschaulicht diese Synchronisation \cite{cyberbotics_controller_programming}.
  
  \begin{wrapfigure}{r}{0.4\textwidth} % r=rechts, l=links
  ...
  gepuffert. Die tatsächliche Ausführung in der Physik\mbox{-}Engine erfolgt erst am nächsten Step\mbox{-}Synchronisationspunkt. 
  ...
  Da für das selbstbalancierende Fahrrad zwei Controller\mbox{-}Prozesse implementiert wurden, die in Webots zeitgleich laufen und 
