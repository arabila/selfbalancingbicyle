    ...
    load_and_apply_config();
     ...
     while (wb_robot_step(timestep) != -1) {
        ...
        if (control_enabled) {
         ...
         printf("Amine: vision_cmd.steer_command: %.2f\n", vision_cmd.steer_command);
         printf("Amine: vision_cmd.speed_command: %.2f\n", vision_cmd.speed_command);
         ...
         if (data != NULL) {
            ...
            printf("Amine: command->steer_command: %.2f\n", command->steer_command);
             ...
             if (command->steer_command >= -1.0f && command->steer_command <= 1.0f &&
                 ...
                 printf("Amine: last_vision_command.steer_command: %.2f\n", last_vision_command.steer_command);
