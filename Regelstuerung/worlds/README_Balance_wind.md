...
Pro Abschnitt den Betrag und das Vorzeichen des x-Anteils in `streamVelocity` anpassen (z. B. `±1.0 0 0` für stärkeren Wind). Die 3-Zonen-Aufteilung bleibt gleich, solange Position/Größe der Boxen beibehalten werden.
